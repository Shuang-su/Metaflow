    ...
    constructor(
        ...
        const updateActive = () => {
            this.active = state.cameraMode === 'walk' &&
                (state.walkInputMode === 'none' || state.walkInputMode === 'mouseclick' || state.walkInputMode === 'touchclick') &&
                !(state.inputMode === 'touch' && state.walkInputMode === 'touchclick');
            if (!this.active) {
                this.svg.style.display = 'none';
                this.cursorPath.style.display = 'none';
            }
        ...
        events.on('walkInputMode:changed', updateActive);
