...
This directory is the Active Metaflow Editor source package. It is a maintained fork of [PlayCanvas SuperSplat Editor](https://github.com/playcanvas/supersplat) `v2.28.0` and retains the upstream MIT license.

- Metaflow product version: `1.1.0`
- Upstream base: `playcanvas/supersplat@v2.28.0`
- Immutable upstream snapshot: [`../supersplat-v2.28.0`](../supersplat-v2.28.0)
- Generated runtime: `dist/` (ignored; built by CI, release, and Netlify)
- Source ownership and local customizations: [`../docs/changes/21-editor-source-ownership/spec.md`](../docs/changes/21-editor-source-ownership/spec.md)

The upstream project documentation follows for license and development context. Metaflow contributors should run `npm ci`, `npm test`, `npm run lint`, and `npm run build` from this directory.

## Upstream SuperSplat Editor
