...
| 产品面 | 当前状态 |
|---|---|
| Viewer | PR 候选 display/app/package `5.19.0`；上游 SuperSplat Viewer `1.29.1` / PlayCanvas `2.21.3`；生产仍为 `5.18.1` |
...
| 资源索引 | schema `1.2` |
| 下一次 Viewer 产品发布 | MF-30 为 `5.19.0` MINOR 候选；合并后须回填最终 SHA，再单独授权 tag、部署与观察 |
