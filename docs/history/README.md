...
| 本轮上游对比快照 | `references/` 中 Viewer `1.26.2/1.28.0/1.29.0`、Editor `2.28.0/2.32.3`、Transform CLI `2.5.1/3.2.0/3.3.0`；`1.28.0/3.2.0` 是执行中保留的前一候选 | 固定三方审查的基准、候选演进与最新稳定输入 | Adopt/Defer/Skip 结论或产品发布状态 |
| 本轮独立审查 | [2026-08-10 SuperSplat 三基线审查](upstream-reviews/2026-08-10/README.md) | Viewer、Editor、Transform 的 B→N、B→M、M↔N 证据、独立决策和后续边界 | 当前产品已升级或已发布 |
