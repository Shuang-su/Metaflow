...
head_before: b9c54c0cf985cdb6908bc0b877312eee453ec4fe
head_after: null
plan_revision: 1
plan_sha256: 4b0f5bbbaa1132978804fbfb37efd65f3e663eca0b52cd9d4757352f5d1fa004
...
Commit and push the locally verified implementation, open PR A as Draft, obtain the exact Head's applicable GitHub Gates and Deploy Preview, smoke `/`, `/editor/`, `/editor/version.json`, and an Editor static asset, then finalize Completion and mark the PR Ready without merge. If hosted validation exposes Issue #15 scope, stop `partial`.
...
- PR / commit / release / deploy: Issue #21 exists; commit and PR pending; release/deploy prohibited.
