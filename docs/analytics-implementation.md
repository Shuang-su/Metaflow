...
> **专项维护资料。** 本文保留 Analytics v1 的详细英文实施说明，不是中文核心手册的独立分支，也不决定 Viewer 是否能加载资源。当前文档入口见 [`docs/README.md`](README.md)；URL 隐私开关摘要见 [Viewer URL 参数](reference/viewer-url-parameters.md#analytics-与隐私参数)。维护本链路时应同时核对当前源码与平台配置。
